...
public class Mob_GreenSlime extends Entity {
    ...
    public void getImage()
    {
        ...
        up3 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        up4 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        down1 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        down2 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        down3 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        down4 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        left1 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        left2 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        left3 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        left4 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        right1 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        right2 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
        right3 = setup("/Mobs/greenslime_down_1", gp.tileSize, gp.tileSize);
        right4 = setup("/Mobs/greenslime_down_2", gp.tileSize, gp.tileSize);
