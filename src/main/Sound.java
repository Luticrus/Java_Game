...
public class Sound {
    ...
    public Sound()
    {
        ...
        soundURL[2]=getClass().getResource("/Sound/DoorSound.wav");
        soundURL[3]=getClass().getResource("/Sound/DoorUnlock.wav");
        soundURL[4]=getClass().getResource("/Sound/Meniu.wav");
        soundURL[5]=getClass().getResource("/Sound/PowerUp.wav");
        soundURL[6]=getClass().getResource("/Sound/BackgroundMusic2.wav");
    ...
    public void setFile(int i)
    {
        try
        {
            ...
            clip.open(ais);
            fo = (FloatControl)clip.getControl(FloatControl.Type.MASTER_GAIN);
            checkVolume();
        }catch(Exception e)
        {
